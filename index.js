...
let audio = new Audio('sound-effects-library-laser-gun.mp3')
let audio1 = new Audio('albatross.mp3')
audio1.volume = 0.4;
let audio2 = new Audio('000990601_prev.mp3')
let audio3 = new Audio('boom.mp3')
